...
async function getData() {
  ...
  export default async function Page() {
    ...
    return (
        <section className="container mx-auto mt-96 grid justify-items-center  border border-sky-500 bg-sky-200 w-1/4  shadow-lg m-x-50 ">
             <header className="flex items-start mt-6">
                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 mr-2 fill-sky-500">
                 <path
